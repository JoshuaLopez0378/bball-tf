...
#     stats = requests.get(url=f"{stats_url}{game_id_url_param}" , headers=headers, timeout=10)
#     print("========== STATS ==========")
#     print(stats)
#     stats_result = stats.json()
#     next_cursor = str(stats_result["meta"]["next_cursor"])
#     stats2 = requests.get(url=stats_url + game_id_url_param + '&cursor=' + next_cursor, headers=headers, timeout=10)
